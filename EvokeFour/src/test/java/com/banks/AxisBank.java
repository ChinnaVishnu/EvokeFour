...
public class AxisBank extends mainbase {
...
@DataProvider(name = "DP63")
	 public Object[][] createData63() throws Exception{
	  Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
		  	                 "login", "Axisbank","Axisbank");
		  	         return(retObjArr);
		  	     } 
	  
	  
@Test(priority=61,dataProvider="DP63")
public void AxisBankAxix(String BankNameaxis,String Email,String Bill ,String Nature ,String exceptedreult,String actualresult,String testresult) throws  WriteException, BiffException, IOException, InterruptedException{		  		
...
Thread.sleep(5000);	
driver.findElement(By.xpath("(//input[@name='inputType'])[22]")).click();
...
//...........................select the axis banks are some many but it will pass the index  it is working......................//
...
ProcessBuilder bulidersecond =new ProcessBuilder("D:\\AUTOMATION REQUIRED DOCS\\BanksUploads\\AxisBank\\batch12_upload.exe");
bulidersecond.start();
...
ExtentTestManager.getTest().log(LogStatus.INFO, " Bank : Axis Bank   actual is started"+bankaxisresulttact);
ExtentTestManager.getTest().log(LogStatus.INFO, " Bank : Axis Bank   Result Comparison  is "+bankaxisresulttact.equals(bankaxisexce));
