...
public class OtherVerificationTDSSecond extends mainbase {
...
Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
             "login", "OtherVerificationtds","OtherVerificationtds");
          return(retObjArr);
      } 


@Test(priority=11,dataProvider="DP11")
public void OTHERVERIFICATIONTDS (String Login  ,String Password  , String Date  , String Assessment ,String exceptedreult,String actualresult, String testresult) throws   BiffException, IOException, InterruptedException, HeadlessException, AWTException{      
	...
	driver.findElement(By.xpath("//div[2]/div[2]/div")).click();
		...
		driver.findElement(By.xpath("//a[text()='Tax']")).click();
		 Thread.sleep(9000);
		driver.findElement(By.xpath("(//input[@name='inputType'])[34]")).click();
		...
		// boolean foundAlert = false;
		   ...
		   try {
			   ...
			   ExtentTestManager.getTest().log(LogStatus.ERROR, "Other Verification : TDS  please  Enter the current  captcha !!");
			...
			//foundAlert = false;
			 ...
			 Thread.sleep(25000);
			  ...
			  // System.out.println(tdsresultexp.equals(actualtdsresult));
			   ...
			   ExtentTestManager.getTest().log(LogStatus.INFO, "Other Verification :TDS   resultexcepted is started"+tdsresultexp);
			   ExtentTestManager.getTest().log(LogStatus.INFO, "Other Verification :TDS   resultactual is started"+actualtdsresult);
			   //ExtentTestManager.getTest().log(LogStatus.INFO, "Other Verification :TDS   resultcomparison is "+tdsresultexp.equals(actualtdsresult));
			   ExtentTestManager.getTest().log(LogStatus.PASS, "Other Verification :TDS   verification Result is Pass");
			   ...
			   //ExtentTestManager.getTest().log(LogStatus.ERROR, "Other Verification :TDS  result is capche not showing");
