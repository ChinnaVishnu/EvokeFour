...
public class ElectricityverificationTamilnadu extends mainbase {
	...
	public Object[][] createData9() throws Exception {
		Object[][] retObjArr = getTableArray(
				...
				"ElectricityverificationTamilnadu", "ElectricityverificationTamilnadu");
		return (retObjArr);
	}
	...
	public void ElectricityAndhraPradeshEstern(String Billing, String Consumer, String Bill, String Nature,
		...
		ExtentTestManager.startTest(" Electricity : Tamilnadu ");
		Thread.sleep(8000);
