...
public class electricityVerificationdelhi2 extends mainbase {

	@DataProvider(name = "DP2")
	public Object[][] createData2() throws Exception {
		Object[][] retObjArr = getTableArray(
				"D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls", "login",
				"ElectricityverificationDelhisecond", "ElectricityverificationDelhisecond");
		return (retObjArr);
	}

	@Test(priority = 16, dataProvider = "DP2")
	public void ElectricityDelhi(String CANumber, String Number, String Bill, String Nature, String exceptedreult,
		 ...
		 * ".//*[@id='electricityDetails']/table/tbody/tr[1]/td[3]/a")).click();
		 */
		...
		try {
			...
			ExtentTestManager.getTest().log(LogStatus.ERROR,
					"Electricity : Delhi  please  Enter the  current captcha  ");
			Thread.sleep(4000);
				...
				try {
					...
					if (resPercentage > 0 && (resPercentage * 100) > 80) {
						...
						ExtentTestManager.getTest().log(LogStatus.INFO,
								"Electricity : Delhi  resultexcepted is started" + electricityresult);
						ExtentTestManager.getTest().log(LogStatus.INFO,
								"Electricity : Delhi  resultactual is started" + electrcitydelhiact);
						// ExtentTestManager.getTest().log(LogStatus.INFO,
						// "Electricity : Delhi resultcomparison is
						// "+electricityresult.equals(electrcitydelhiact));
						...
						// test.log(LogStatus.INFO, "Screenshortbelow
						// :"+test.addScreenCapture(GetScreenshort2.capture(driver,
						// "ScreenshortForExtentReport")));

						ExtentTestManager.getTest().log(LogStatus.INFO,
								"Screenshortbelow :" + ExtentTestManager.getTest().addScreenCapture(
										GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
						...
						ExtentTestManager.getTest().log(LogStatus.INFO,
								"Electricity : Delhi  resultactual is started" + electrcitydelhiact);
						ExtentTestManager.getTest().log(LogStatus.INFO, "Electricity : Delhi  resultcomparison is "
								+ electricityresult.equals(electrcitydelhiact));
						ExtentTestManager.getTest().log(LogStatus.INFO,
								"Screenshortbelow :" + ExtentTestManager.getTest().addScreenCapture(
										GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
					...
					// test.log(LogStatus.WARNING, "Electricity : Delhi Result
					// is source site busy please try later");

					driver.close();
					driver.switchTo().window(mainhandleandhra);
					// Assert.assertEquals(electrcitydelhiact,
					// electricityresult);
				} catch (Exception e) {
					ExtentTestManager.getTest().log(LogStatus.ERROR, "Electricity : Delhi Request on site timed out");
