...
public class otherverificationefilling2 extends mainbase {
	...
	@Test(priority = 14, dataProvider = "DP1")
	public void otherverificationefilling(String loginid, String Password, String dateofbirth, String empty,
		...
		ExtentTestManager.startTest(" ITR Login(2015-2016) ");

		Thread.sleep(9000);
		driver.findElement(By.xpath("//a[text()='Tax']")).click();
		Thread.sleep(9000);
		driver.findElement(By.xpath("//div[text()='  ITR Login(2015-2016)']/input")).click();
			...
			try {
				...
				try {
					...
					ExtentTestManager.getTest().log(LogStatus.ERROR,
							" ITR Login(2015-2016)  please  Enter the current  captcha !!");
					...
					if (resPercentage > 0 && (resPercentage * 100) > 80) {
						...
						ExtentTestManager.getTest().log(LogStatus.INFO,
								" ITR Login(2015-2016) resultexcepted is started" + otherefillingresult);
						ExtentTestManager.getTest().log(LogStatus.INFO,
								" ITR Login(2015-2016) resultactual is started" + otherdfillingactualresult);
						// ExtentTestManager.getTest().log(LogStatus.INFO,
						// "Other Verification : e-Filing resultcomparison is
						// "+otherefillingresult.equals(otherdfillingactualresult));
						ExtentTestManager.getTest().log(LogStatus.PASS,
								" ITR Login(2015-2016)  Result is Pass");
						...
						ExtentTestManager.getTest().log(LogStatus.FAIL,
								" ITR Login(2015-2016)  Result is FAIL");
						...
						ExtentTestManager.getTest().log(LogStatus.INFO,
								" ITR Login(2015-2016) resultactual is started" + otherdfillingactualresult);
						ExtentTestManager.getTest().log(LogStatus.INFO,
								" ITR Login(2015-2016) resultcomparison is "
										+ otherefillingresult.equals(otherdfillingactualresult));
					...
					ExtentTestManager.getTest().log(LogStatus.ERROR,
							" ITR Login(2015-2016)  Request timeout issuse ");
				}
