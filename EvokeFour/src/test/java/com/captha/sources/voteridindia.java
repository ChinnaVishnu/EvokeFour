...
public class voteridindia extends mainbase {

	@DataProvider(name = "DP14")
	public Object[][] createData14() throws Exception {
		Object[][] retObjArr = getTableArray(
				"D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls", "login", "voteridindia",
				"voteridindia");
		return (retObjArr);
	}
			...
			try {
				...
				if (resPercentage > 0 && (resPercentage * 100) > 80) {
					...
					ExtentTestManager.getTest().log(LogStatus.INFO,
							"VoterId : India    resultexcepted is started" + voteridindia);
					ExtentTestManager.getTest().log(LogStatus.INFO,
							"VoterId : India    resultactual is started" + voteridindiaactualresult);
					// ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId
					// : India resultcomparison is
					// "+voteridindia.equals(voteridindiaactualresult));
				...
				ExtentTestManager.getTest().log(LogStatus.ERROR, "VoterId : India Request on site timed out");
				String screenshortpath = GetScreenshort.capture(driver, "ScreenshortForExtentReport");
