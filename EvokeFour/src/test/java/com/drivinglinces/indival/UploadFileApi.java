...
import com.allclasses.UploadFilepage;
...
public class UploadFileApi extends mainbase {
...
public Object[][] createData62() throws Exception{
 Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
	  	                 "login", "Logingmailluploadfile","Logingmailluploadfile");
	  	         return(retObjArr);
	  	     }
		  
		  
	  @Test(priority=59,dataProvider="DP62")
	  public void UploadFileZZ(String Password   ,String Ward ,String Bill,String Nature ,String exceptedreult,String actualresult,String testresult) throws  WriteException, BiffException, IOException, InterruptedException{		  		
