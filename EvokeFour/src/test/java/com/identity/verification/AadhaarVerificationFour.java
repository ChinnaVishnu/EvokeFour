...
public class AadhaarVerificationFour extends mainbase {
	
	
	@DataProvider(name = "DP1")
    public Object[][] createData1() throws Exception{
        Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
                "login", "LogingmaillAadharverification","LogingmaillAadharverification");
        return(retObjArr);
    }
...
public void Aadharverification(String AADHAAR,String Applicants,String Birth,String Gender,String exceptedreult,String actualresult,String testresult) throws   IOException, InterruptedException, HeadlessException, AWTException{
...
driver.findElement(By.xpath("//input[@value='aadhaar']")).click();

//.................................AADHAAR Number (12 Digits)..................................................................//
driver.findElement(By.xpath("//input[@id='strAadhaar']")).sendKeys(AADHAAR);

//...................................Applicants Name as per AADHAAR card......................................................//
...
//Assert.assertEquals(Aadharverificationexcepted, Actalalet);	
...
ExtentTestManager.getTest().log(LogStatus.INFO, "Aadhar verification  excepted is started"+Aadharverificationexcepted); 
ExtentTestManager.getTest().log(LogStatus.INFO, "Aadhar verification  resultactual is started"+Actalalet); 
ExtentTestManager.getTest().log(LogStatus.INFO, "Aadhar verification  Result Comparison is "+Aadharverificationexcepted.equals(Actalalet)); 
...
/*
if(driver.findElement(By.xpath(".//*[@id='loadingmessage']/img")).isDisplayed()){
...
driver.navigate().refresh();
	...
	ExtentTestManager.getTest().log(LogStatus.WARNING, "Aadhar verification   server did not provide any stacktrace information");
	ExtentTestManager.getTest().log(LogStatus.INFO, "Screenshortbelow :"+ExtentTestManager.getTest().addScreenCapture(GetScreenshort.capture(driver, "ScreenshortForExtentReport")));
