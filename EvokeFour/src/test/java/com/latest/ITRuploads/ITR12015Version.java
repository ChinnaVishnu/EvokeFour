...
public class ITR12015Version extends mainbase {

	@DataProvider(name = "DP47")
	public Object[][] createData47() throws Exception {
		Object[][] retObjArr = getTableArray(
				"D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls", "login", "ITR12015",
				"ITR12015");
		return (retObjArr);
	}

	@Test(priority = 62, dataProvider = "DP47")
	public void ITRUploadVV(String ITRVersion, String Password, String empty, String seempty, String exceptedreult,
		...
		ExtentTestManager.startTest(" ITR1-2015 ");
		...
		ProcessBuilder bulidersecond = new ProcessBuilder(
				"D:\\AUTOMATION REQUIRED DOCS\\NewITRUploads\\ITRAllVersions\\ITR1-2015\\batch12_upload.exe");
		bulidersecond.start();
		...
		if (resPercentage > 0 && (resPercentage * 100) > 80) {
			...
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR1-2015  excepted is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR1-2015 actual is started" + uploadresultact);
			// ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2015
			// Result Comparison is "+uploadresultact.equals(uploadresult));
			ExtentTestManager.getTest().log(LogStatus.PASS, " ITR1-2015  Result is Pass");
			...
			ExtentTestManager.getTest().log(LogStatus.FAIL, " ITR1-2015  Result is Fail");

			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR1-2015  excepted is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR1-2015  actual is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO,
					" ITR1-2015  Result Comparison  is " + uploadresultact.equals(uploadresult));
			String screenshortpath = GetScreenshort.capture(driver, "ScreenshortForExtentReport");
