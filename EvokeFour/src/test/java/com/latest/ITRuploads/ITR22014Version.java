...
public class ITR22014Version extends mainbase {

	@DataProvider(name = "1")
	public Object[][] createData1() throws Exception {
		Object[][] retObjArr = getTableArray(
				"D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls", "login", "ITR22014",
				"ITR22014");
		return (retObjArr);
	}

	@Test(priority = 63, dataProvider = "1")
	public void ITRUploadVVSS(String ITRVersion, String Password, String empty, String seempty, String exceptedreult,
		...
		ExtentTestManager.startTest(" ITR2-2014 ");
		...
		ProcessBuilder bulidersecond = new ProcessBuilder(
				"D:\\AUTOMATION REQUIRED DOCS\\NewITRUploads\\ITRAllVersions\\ITR2-2014\\batch12_upload.exe");
		bulidersecond.start();
		...
		if (resPercentage > 0 && (resPercentage * 100) > 80) {
			...
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2014  excepted is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2014 actual is started" + uploadresultact);
			// ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2014
			// Result Comparison is "+uploadresultact.equals(uploadresult));
			ExtentTestManager.getTest().log(LogStatus.PASS, " ITR2-2014  Result is Pass");
			...
			ExtentTestManager.getTest().log(LogStatus.FAIL, " ITR2-2014  Result is Fail");

			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2014  excepted is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO, " ITR2-2014 actual is started" + uploadresultact);
			ExtentTestManager.getTest().log(LogStatus.INFO,
					" ITR2-2014  Result Comparison  is " + uploadresultact.equals(uploadresult));
			String screenshortpath = GetScreenshort.capture(driver, "ScreenshortForExtentReport");
