...
public class ITRAck2016Version  extends mainbase{

	
	@DataProvider(name = "1")
	 public Object[][] createData1() throws Exception{
	  Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
		  	                 "login", "ITRAck2016","ITRAck2016");
		  	         return(retObjArr);
		  	     } 
	
	
	
	@Test(priority=67,dataProvider="1")
	public void ITRUploadVVS (String ITRVersion  ,String Password  ,String empty ,String seempty ,String exceptedreult,String actualresult,String testresult) throws  WriteException, BiffException, IOException, InterruptedException{		  		

		  ExtentTestManager.startTest(" ITRAck-2016 "); 
		  ...
		  Thread.sleep(4000);
		  ProcessBuilder bulidersecond =new ProcessBuilder("D:\\AUTOMATION REQUIRED DOCS\\NewITRUploads\\ITRAllVersions\\ITRAck-2016\\batch12_upload.exe");
			bulidersecond.start();
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, " ITRAck-2016  excepted is started"+uploadresultact);
		ExtentTestManager.getTest().log(LogStatus.INFO, " ITRAck-2016 actual is started"+uploadresultact);
		ExtentTestManager.getTest().log(LogStatus.INFO, " ITRAck-2016 Result Comparison  is "+uploadresultact.equals(uploadresult));
		ExtentTestManager.getTest().log(LogStatus.PASS, " ITRAck-2016 Result is Pass");
		...
		ExtentTestManager.getTest().log(LogStatus.FAIL, " ITRAck-2016  Result is Fail");
