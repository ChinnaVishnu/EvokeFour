...
public class VoterIdAndman extends mainbase {
	...
	public Object[][] createData62() throws Exception {
		Object[][] retObjArr = getTableArray(
				...
				"VoterIDVerificationAndaman", "VoterIDVerificationAndaman");
		return (retObjArr);
	}

	@Test(priority = 8, dataProvider = "DP62")
	public void voteridindia(String EPIC, String Service, String Bill, String Nature, String exceptedreult,
		...
		try {
			...
			try {
				...
				String voteridAdmanactualresult = driver.findElement(By.xpath(".//*[@id='result_div']/div")).getText();
				...
				if (resPercentage > 0 && (resPercentage * 100) > 80) {
					...
					ExtentTestManager.getTest().log(LogStatus.INFO,
							"VoterId : Andaman excepted is started" + voteridAdmana);
					ExtentTestManager.getTest().log(LogStatus.INFO,
							"VoterId : Andaman  actual is started" + voteridAdmanactualresult);
					// ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId
					// : Andaman Result Comparison is
					// "+voteridAdmana.equals(voteridAdmanactualresult));
					...
					ExtentTestManager.getTest().log(LogStatus.INFO,
							"VoterId : Andaman  actual is started" + voteridAdmanactualresult);
					ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId : Andaman   Result Comparison  is "
							+ voteridAdmana.equals(voteridAdmanactualresult));
