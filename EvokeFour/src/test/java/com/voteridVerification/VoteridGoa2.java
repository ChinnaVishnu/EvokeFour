...
public class VoteridGoa2  extends mainbase{
...
public Object[][] createData59() throws Exception{
 Object[][] retObjArr=getTableArray("D:\\AUTOMATION REQUIRED DOCS\\EVOKEAPIWEBSERVICES\\EvokeApiAutoamtion.xls",
	  	                 "login", "voteridGoaverification","voteridGoaverification");
	  	         return(retObjArr);
	  	     } 
...
public void voteridGoaverification(String District   ,String Voter  ,String Number ,String Nature ,String exceptedreult,String actualresult,String testresult) throws  WriteException, BiffException, IOException, InterruptedException{		  		
...
String voteridgoactualresult=fluentWait(By.xpath(".//*[@id='result_div']/div")).getText();
...
ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId : Goa  excepted is started"+voteridgoaexcepted);
ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId : Goa  actual is started"+voteridgoactualresult);
ExtentTestManager.getTest().log(LogStatus.INFO, "VoterId : Goa  Result Comparison  is "+voteridgoactualresult.equals(voteridgoaexcepted));
