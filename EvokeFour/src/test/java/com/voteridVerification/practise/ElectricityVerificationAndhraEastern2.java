...
public class ElectricityVerificationAndhraEastern2 extends mainbase {
	...
	public Object[][] createData9() throws Exception {
		Object[][] retObjArr = getTableArray(
				...
				"ElectricityVerificationAPEastern", "ElectricityVerificationAPEastern");
		return (retObjArr);
	}
	...
	public void ElectricityAndhraPradeshEstern(String PowerDistribution, String ServiceNumber, String Bill, String Nature,
		...
		ExtentTestManager.startTest(" Electricity Verification :Andhra Pradesh(Eastern) ");
		//Thread.sleep(8000);
		...
		try {
			...
			try {
				...
				Thread.sleep(8000);
				driver.findElement(By.xpath(".//*[@id='electricityNo1']")).sendKeys(ServiceNumber);

				Thread.sleep(10000);
				// Thread.sleep(20000);

				driver.findElement(By.xpath(".//*[@id='electricityEsternDiv']/div/span[1]/input")).click();
